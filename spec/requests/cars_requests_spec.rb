...
RSpec.describe 'Cars API', type: :request do
  ...
  describe 'GET /api/v1/cars' do
    it 'returns a list of cars' do
      Car.create(name: 'Tesla Model S', image: 'tesla.jpg', model: 'Model S', price: 50_000, user: user)
  ...
  describe 'POST /api/v1/cars' do
    it 'creates a new car' do
      car_params = { name: 'Tesla Model 3', image: 'tesla.jpg', model: 'Model 3', price: 40_000, user_id: user.id }
  ...
  describe 'PATCH /api/v1/cars/:id' do
    it 'updates an existing car' do
      car = Car.create(name: 'Tesla Model S', image: 'tesla.jpg', model: 'Model S', price: 50_000, user: user)
